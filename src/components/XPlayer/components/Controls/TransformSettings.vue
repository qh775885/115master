<template>
    <div class="card card-sm bg-neutral-800">
        <div class="card-body">
            <h3 class="card-title">旋转与翻转</h3>
            <div>
                <!-- 旋转控制 -->
                <fieldset class="fieldset">
                    <legend class="fieldset-legend w-full">旋转 <span class="badge badge-sm">{{ transform.rotate.value }}°</span></legend>
                ...
                <!-- 翻转控制 -->
                <fieldset class="fieldset">
                    <legend class="fieldset-legend">翻转</legend>
                    <div class="flex gap-2">
                        <button 
