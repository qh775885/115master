        ...
        <div class="card-body">
            ...
            <div>
                ...
                <fieldset class="fieldset">
                    <legend class="fieldset-legend">采样间隔 (S)</legend>
                ...
                <!-- 自动缓冲 -->
                <fieldset class="fieldset">
                    <legend class="fieldset-legend">自动缓冲</legend>
                    <input type="checkbox" :checked="thumbnailSettings.autoLoadThumbnails.value" 
